...
namespace Edgar.Unity.Examples
{
        ...
        where TGameManager : class
    {
        ...
        protected void ShowLoadingScreen(string primaryText, string secondaryText)
        {
            ...
            var primaryTextComponent = loadingImage?.transform.Find("PrimaryText")?.gameObject.GetComponent<TextMeshProUGUI>();
            var secondaryTextComponent = loadingImage?.transform.Find("SecondaryText")?.gameObject.GetComponent<TextMeshProUGUI>();
